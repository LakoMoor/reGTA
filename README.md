<img src="https://github.com/lakomoor/reGTA/blob/re3/res/images/logo_1024.png?raw=true" alt="re3 logo" width="200">

[![Build Status](https://img.shields.io/endpoint.svg?url=https%3A%2F%2Factions-badge.atrox.dev%2FLakoMoor%2FreGTA%2Fbadge%3Fref%3Dre3&style=flat)](https://actions-badge.atrox.dev/lakomoor/reGTA/goto?ref=re3)

## Intro

In this repository you'll find the fully reversed source code for GTA III ([re3](https://github.com/lakomoor/reGTA/tree/re3/) branch) and GTA VC ([miami](https://github.com/lakomoor/reGTA/tree/miami/) branch).
...
- Build re3 or download the latest build:
  - [Windows D3D9 MSS 32bit](https://nightly.link/lakomoor/reGTA/workflows/re3_msvc_x86/re3/re3_Release_win-x86-librw_d3d9-mss.zip)
  - [Windows D3D9 64bit](https://nightly.link/lakomoor/reGTA/workflows/re3_msvc_amd64/re3/re3_Release_win-amd64-librw_d3d9-oal.zip)
  - [Windows OpenGL 64bit](https://nightly.link/lakomoor/reGTA/workflows/re3_msvc_amd64/re3/re3_Release_win-amd64-librw_gl3_glfw-oal.zip)
  - [Linux 64bit](https://nightly.link/lakomoor/reGTA/workflows/build-cmake-conan/re3/ubuntu-18.04-gl3.zip)
  - [MacOS 64bit x86-64](https://nightly.link/lakomoor/reGTA/workflows/build-cmake-conan/re3/macos-latest-gl3.zip)
...
Clone the repository with `git clone --recursive https://github.com/lakomoor/reGTA.git`. Then `cd re3` into the cloned repository.
...
mkdir build
cd build
conan install .. reGTA/re3@ -if build -o re3:audio=openal -o librw:platform=gl3 -o librw:gl3_gfxlib=glfw --build missing -s re3:build_type=RelWithDebInfo -s librw:build_type=RelWithDebInfo
...
> :information_source: There are various settings in [config.h](https://github.com/lakomoor/reGTA/tree/re3/src/core/config.h), you may want to take a look there.
...
We have a [Coding Style](https://github.com/lakomoor/reGTA/blob/re3/CODING_STYLE.md) document that isn't followed or enforced very well.
